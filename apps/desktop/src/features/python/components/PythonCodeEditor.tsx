...
export function PythonCodeEditor({
  ...
  useEffect(() => {
    ...
    const model = monaco.editor.createModel(
      initial.value,
      "python",
      monaco.Uri.parse("inmemory://python/python-session.py"),
    );
  ...
  return (
    <div
      ...
      className="min-h-[92px] min-w-0 overflow-hidden rounded-[7px] border border-cg-border bg-cg-editor focus-within:border-cg-focus"
      ref={editorHostRef}
    />
  );
}
