...
pub const INDEX_FORMAT: &str = "bioeng.backup.index.v1";
pub const SNAPSHOT_FORMAT: &str = "bioeng.backup.snapshot.v1";
    ...
    fn manifest_serializes_stable_format() {
        let manifest = SnapshotManifest {
            ...
            database: BackupFileEntry {
                logical_path: "bioeng.sqlite3".to_string(),
                size_bytes: 1,
                sha256: "a".repeat(64),
        ...
        assert!(serialized.contains("bioeng.backup.snapshot.v1"));
